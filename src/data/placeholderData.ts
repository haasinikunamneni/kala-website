...
export const suppliers: Supplier[] = [
  {
    ...
    artisanStory:
      "Our current collection is brought to life by a family of hereditary artisans in a small village in Odisha, where the craft has travelled quietly from one generation to the next. Every brushstroke carries the memory of those who came before — a practice shaped by patience, devotion, and years of inherited knowledge. Each work is therefore not merely painted by hand, but carries a lineage of its own. No two works are ever identical. Each pigment is prepared fresh on the day of painting, making every piece a singular expression of a craft that has endured through centuries.",
    comingSoon: false,
    palette: ["#B95D3F", "#BB9569", "#1D1D1B"],
...
const seed: Array<Omit<Painting, "palette" | "supplierSlug" | "artForm" | "origin">> = [
  ...
  },
  {
    ...
    price: 15000,
    tags: ["Mandala"],
    description: "A handcrafted Odisha Pattachitra featuring Mahā Rāsa Līlā at its center, encircled by the Daśāvatāra Maṇḍala, symbolizing Lord Vishnu's divine incarnations. Intricately painted using traditional techniques, it embodies the spiritual richness and storytelling heritage of Odisha.",
...
export const paintings: Painting[] = seed.map((p) => ({
  ...
  artForm:      "Pattachitra",
  origin:       "Odisha, India",
  palette:      ["#B95D3F", "#BB9569", "#EFE8DD"] as [string, string, string],
}));
